   ...
   #     print("The current piece is ", quintris.get_piece())
    ...
    def evaluation_function(self,board,type_val):
        ...
        if type_val=="N_of_empty_blocks":
            ...
            return gaps-height+column_gap-1000*line_filled+val
    ...
    def successor_boards(self,piece,next_piece,board):
        ...
        for rotate_angle in rotation:
            ...
            for left in range(0,15):
                ...
                for i in range(0,left):
                    ...
                    # new_temp_board=quintris_game_copy.get_board()
                    # if temp_board==new_temp_board:
                    #     print("David Sir")
                    #     break
                    # else:
                    #     temp_board= new_temp_board.copy()
                    #     print("DRYTUYIUSOID")
                    left_tracker.append("b")
                quintris_game_copy.down()
                # print(left_tracker)
                move_tracker[rotate_move+"b"*len(left_tracker)] = (quintris_game_copy.get_board(),self.evaluation_function(quintris_game_copy.get_board(),"Weighted_row_coverage_and_lessgaps"))
            ...
            for right in range(0,15):
                ...
                quintris_game_copy.down()
                move_tracker[rotate_move+"m"*len(right_tracker)] = (quintris_game_copy.get_board(),self.evaluation_function(quintris_game_copy.get_board(),"Weighted_row_coverage_and_lessgaps"))


        # for each in move_tracker.keys():
        #     print(each,"  ",move_tracker[each][1])
                    
        pos_moves=[x for x in move_tracker]
        print(pos_moves)
        ...
        # print("Current Board -_______________________--")
        # quintris.print_board(quintris.get_board())
        # print(quintris.get_piece())
        # i=quintris.get_piece()[2]
        # left_boards=[]
        # while i>=0:
        #     quintris.left()
        #     quintris.down()
        #     quintris.print_board(quintris.get_board())
        #     left_boards.append(quintris.get_board())
        # for each in left_boards:
        #     print("Pradeep Check")
        #     quintris.print_board(each)
